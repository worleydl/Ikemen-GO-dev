...
func (s *System) init(w, h int32) *lua.LState {
	...
	s.debugc1hitTex = PaletteTexture()
	s.debugc1revTex = PaletteTexture()
	s.debugc1notTex = PaletteTexture()
	s.debugc2Tex = PaletteTexture()
	s.debugc2hbTex = PaletteTexture()
	s.debugc2mtkTex = PaletteTexture()
	s.debugc2grdTex = PaletteTexture()
	s.debugc2stbTex = PaletteTexture()
	s.debugcsizeTex = PaletteTexture()
	s.debugchTex = PaletteTexture()
